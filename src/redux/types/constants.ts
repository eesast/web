...
export const GET_ARTICLE_BY_ALIAS_REQUEST = "GET_ARTICLE_BY_ALIAS_REQUEST";
export const GET_ARTICLE_BY_ALIAS_SUCCESS = "GET_ARTICLE_BY_ALIAS_SUCCESS";
export const GET_ARTICLE_BY_ALIAS_FAILURE = "GET_ARTICLE_BY_ALIAS_FAILURE";
