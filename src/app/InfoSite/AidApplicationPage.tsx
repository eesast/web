  ...
  return (
    ...
    >
      ...
      <Timeline>
        <Timeline.Item
          color={
            new Date() >= info.aid.start_A && new Date() <= info.aid.end_A
              ? "green"
              : "red"
          }
        >
          <p>第一阶段：助学金申请</p>
          <p>
            {info.aid.start_A.toLocaleString()} ~{" "}
            {info.aid.end_A.toLocaleString()}
          </p>
        </Timeline.Item>
        <Timeline.Item
          color={
            new Date() >= info.aid.start_B && new Date() <= info.aid.end_B
              ? "green"
              : "red"
          }
        >
          <p>第二阶段：助学金申请结果公示</p>
          <p>
            {info.aid.start_B.toLocaleString()} ~{" "}
            {info.aid.end_B.toLocaleString()}
          </p>
        </Timeline.Item>
      </Timeline>
          ...
          >
            ...
            >
              ...
              <Form.Item
                name="aid"
                label="助学金"
                rules={[{ required: true, message: "请输入助学金名称" }]}
              >
              ...
              <Form.Item
                name="code"
                label="代码"
                rules={[{ required: true, message: "请输入助学金代码" }]}
              >
                <Input />
              </Form.Item>
              <Form.Item
                name="amount"
                label="金额"
                rules={[{ required: true, message: "请输入助学金金额" }]}
              >
                <Input type="number" />
              </Form.Item>
              <Form.Item name="form_url" label="专用申请表">
