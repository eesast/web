function createUnityInstance(e, r, n) {
  ...
  function o(e) {
    ...
    if (
      (t.startsWith(n) && (t = t.substring(n.length)),
      (n += "\n" + t.trim()),
    ...
    if ("symbolsUrl" != e) {
      ...
      t ||
        ...
        "object" != typeof r ||
          ...
          (t.started ||
            ((t.started = !0), (t.lengthComputable = r.lengthComputable)),
          (t.total = r.total),
          (t.loaded = r.loaded),
  ...
  h.forEach(function (r) {
    ...
    c.deinitializers.push(function () {
      ...
      for (var r in c.intervals) window.clearInterval(r);
      c.intervals = {};
    }),
  ...
  document.addEventListener("webkitfullscreenchange", function (r) {
    ...
    n === e
      ? e.style.width &&
        ...
        (e.style.width = "100%"),
        (e.style.height = "100%"))
      : g && ((e.style.width = g), (e.style.height = p), (g = ""), (p = ""));
  });
  var b = {
    Module: c,
  ...
  return (
    ...
    (c.fetchWithProgress = (function () {
      ...
      function r(r, n) {
        var t = function () {};
        return (
          n && n.onProgress && (t = n.onProgress),
          fetch(r, n).then(function (r) {
            function n() {
            ...
            function o() {
              ...
              e.set(l, 0);
              for (var r = c, n = 0; n < d.length; ++n)
                e.set(d[n], r), (r += d[n].length);
              return e;
            }
            var a = "undefined" != typeof r.body ? r.body.getReader() : void 0,
              i = "undefined" != typeof r.headers.get("Content-Length"),
              s = e(r, i),
              l = new Uint8Array(s),
              d = [],
              u = 0,
