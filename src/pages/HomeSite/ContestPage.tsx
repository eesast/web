...
const ContestPage: React.FC = () => {
  return (
    ...
    >
        ...
        <StyledTypography>
          ...
          <Center direction="column">
            <Image
              ...
              src={`${process.env.STATIC_URL}/public/images/ts16.jpg`}
            />
            队式十六——深蓝 (Deep Blue)
            <br />
          </Center>
          <Center direction="column">
            <Image
              ...
              src={`${process.env.STATIC_URL}/public/images/ts17.jpg`}
            />
            队式十七——Stellar Craft
            <br />
          </Center>
          <Center direction="column">
            <Image
              alt="队式十八——CPClash"
              src={`${process.env.STATIC_URL}/public/images/ts18.jpg`}
            />
            队式十八——CPClash
            <br />
          </Center>
          <Center direction="column">
            <Image
              alt="队式十九"
              src={`${process.env.STATIC_URL}/public/images/ts19.jpg`}
            />
          ...
          <Center direction="column">
            <Image
              ...
              src={`${process.env.STATIC_URL}/public/images/ts20.jpg`}
            />
            队式二十——THU-AI 枪林弹雨组
            <br />
          </Center>
      ...
      <TabPane tab="电子设计大赛" key="edc">
        <StyledTypography>
          ...
          <Center direction="column">
            <Image
              alt="第十八届电子设计大赛——天赐良机"
              src={`${process.env.STATIC_URL}/public/images/edc18.jpg`}
            />
            第十八届电子设计大赛——天赐良机
            <br />
          </Center>
          <Center direction="column">
            <Image
              alt="第十九届电子设计大赛——绿茵荣耀"
              src={`${process.env.STATIC_URL}/public/images/edc19.jpg`}
            />
            第十九届电子设计大赛——绿茵荣耀
            <br />
          </Center>
          <Center direction="column">
            <Image
              alt="第二十届电子设计大赛——智圆行方"
              src={`${process.env.STATIC_URL}/public/images/edc20.jpg`}
            />
            第二十届电子设计大赛——智圆行方
            <br />
          </Center>
            ...
            <Row justify="center" align="middle">
              <Col>
                <Image
                  ...
                  src={`${process.env.STATIC_URL}/public/images/hwdc2017-1.jpg`}
                />
              </Col>
              <Col>
                <Image
                  alt="2017 年硬件设计大赛作品 2"
                  src={`${process.env.STATIC_URL}/public/images/hwdc2017-2.jpg`}
                />
              </Col>
            </Row>
            <br />
            ...
            <Row justify="center" align="middle">
              <Col>
                <Image
                  ...
                  src={`${process.env.STATIC_URL}/public/images/hwdc2018-1.gif`}
                />
              </Col>
              <Col>
                <Image
                  alt="2018 年硬件设计大赛作品 2"
                  src={`${process.env.STATIC_URL}/public/images/hwdc2018-2.jpg`}
                />
              </Col>
            </Row>
            <br />
            ...
            <Row justify="center" align="middle">
              <Col>
                <Image
                  ...
                  src={`${process.env.STATIC_URL}/public/images/hwdc2019-1.gif`}
                />
              </Col>
              <Col>
                <Image
                  alt="2019 年硬件设计大赛作品 2"
                  src={`${process.env.STATIC_URL}/public/images/hwdc2019-2.gif`}
                />
              </Col>
            </Row>
            <br />
      ...
      <TabPane tab="软件设计大赛" key="sdc">
        <StyledTypography>
          ...
          <Center direction="column">
            ...
            <Image
              alt="多功能计算器 CalcPro"
              src={`${process.env.STATIC_URL}/public/images/swdc2018-1.png`}
            />
            多功能计算器 CalcPro
            <br />
            <Image
              alt="简易操作系统 BASIC-OS1"
              src={`${process.env.STATIC_URL}/public/images/swdc2018-2.jpg`}
            />
            简易操作系统 BASIC-OS1
            <br />
            <Image
              alt="校园网管理软件 .NetCampus"
              src={`${process.env.STATIC_URL}/public/images/swdc2018-3.jpg`}
            />
            校园网管理软件 .NetCampus
            <br />
          </Center>
          <Center direction="column">
            ...
            <Image
              ...
              src={`${process.env.STATIC_URL}/public/images/swdc2019-1.png`}
            />
            音乐节奏游戏 TuneStory
            <br />
            <Image
              alt="三角形滤镜 LowPoly"
              src={`${process.env.STATIC_URL}/public/images/swdc2019-2.png`}
            />
            三角形滤镜 LowPoly
            <br />
            <Image
              alt="在线多功能绘图"
              src={`${process.env.STATIC_URL}/public/images/swdc2019-3.png`}
            />
            在线多功能绘图
            <br />
          </Center>
      ...
      <TabPane tab="挑战杯" key="challenge-cup">
        <StyledTypography>
      ...
      <TabPane tab="新生知识竞赛" key="knowledge-contest">
        <StyledTypography>
          ...
          <Center direction="column">
            <Image
              alt="第十五届决赛"
              src={`${process.env.STATIC_URL}/public/images/fic15.jpg`}
            />
            第十五届决赛
            <br />
            <Image
              alt="第十六届决赛"
              src={`${process.env.STATIC_URL}/public/images/fic16.jpg`}
            />
            第十六届决赛
            <br />
            <Image
              alt="第十七届决赛"
              src={`${process.env.STATIC_URL}/public/images/fic17.jpg`}
            />
            第十七届决赛
            <br />
          </Center>
