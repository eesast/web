...
export const SORT_TEAMS_REQUEST = "SORT_TEAMS_REQUEST";
export const SORT_TEAMS_SUCCESS = "SORT_TEAMS_SUCCESS";
export const SORT_TEAMS_FAILURE = "SORT_TEAMS_FAILURE";
